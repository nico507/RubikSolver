...
def lectura_cara(n,M):
    ...
    colors.append(mapeo(mdm_1), M)
    colors.append(mapeo(mdm_2), M)
    colors.append(mapeo(mdm_3), M)
    colors.append(mapeo(mdm_4), M)
    colors.append(mapeo(mdm_5), M)
    colors.append(mapeo(mdm_6), M)
    colors.append(mapeo(mdm_7), M)
    colors.append(mapeo(mdm_8), M)
    colors.append(mapeo(mdm_9), M)
